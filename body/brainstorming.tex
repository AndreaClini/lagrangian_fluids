...
We want to relate this to the equation of state $p=p(\rho,s)$, where $s$ is the entropy density.
Or better, to the ratio $w:=p/\rho$ and to the adiabatic speed of sound
\begin{equation}
    c_a^2 := \left(\frac{\partial p}{\partial \rho}\right)_s.
\end{equation} 