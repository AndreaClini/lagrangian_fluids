...
\begin{equation}
    u^\mu=\frac{1}{3!\,\,\sqrt{B}}\epsilon^{\mu\alpha\beta\gamma}\,\,\epsilon_{ijk}\,\,\partial_\alpha \phi^i \partial_\beta \phi^j \partial_\gamma \phi^k,
\end{equation}
...
\end{align}
Then metric volume form is
\begin{equation}
    \Omega=\sqrt{-g}\,\, dx^0 \wedge dx^1 \wedge dx^2 \wedge dx^3= \sqrt{-g}\,\,\epsilon_{\mu\nu\rho\sigma}\,\, dx^\mu \otimes dx^\nu \otimes dx^\rho \otimes dx^\sigma.
\end{equation}
Up to normalization, the velocity dual is then
\begin{align}
    \tilde{u}_\lambda &= \Omega\big(\,\partial_\lambda,\, (d\phi^1 \wedge d\phi^2 \wedge d\phi^3)^{\#}\big)
    \\
    &= \sqrt{-g}\,\, \epsilon_{\lambda\mu\nu\rho} \,\,\epsilon_{ijk}\,\, \partial^\mu \phi^i \partial^\nu \phi^j \partial^\rho \phi^k\,\,
    dx^\mu \otimes dx^\nu \otimes dx^\rho \otimes dx^\sigma \big(\partial_\lambda, \, \partial_\mu,\, \partial_\nu,\, \partial_\rho\big)
    \\
    &= \sqrt{-g}\,\, \epsilon_{\lambda\mu\nu\rho} \,\,\epsilon_{ijk}\,\, \partial^\mu \phi^i \partial^\nu \phi^j \partial^\rho \phi^k.
\end{align}
The norm is then
\begin{align}
    ...
    &= \left(\sqrt{-g}\right)^2 \underbrace{\,g^{\alpha\lambda}\,\,\epsilon_{\alpha\beta\gamma\delta}\,\, \epsilon_{\lambda\mu\nu\rho}}_{=3!\,\,g_{\mu\beta}\,g_{\nu\gamma}\,g_{\rho\delta}}\,\, \underbrace{\epsilon_{ijk}\,\, \epsilon_{pqr}}_{=3!\,\,\delta_p^1\,\delta_q^2\,\delta_r^3\,\,\epsilon_{ijk}} \,\, \partial^\beta \phi^i \partial^\gamma \phi^j \partial^\delta \phi^k \,\,\, \partial^\mu \phi^p \partial^\nu \phi^q \partial^\rho \phi^r 
    \\
    &=
    \left(\sqrt{-g}\right)^2\,\, (3!)^2 \,\, \epsilon_{ijk}\,\,\partial_\mu\phi^1\partial^\mu\phi^i\,\,\partial_\nu\phi^2\partial^\nu\phi^j\,\,\partial_\rho\phi^3\partial^\rho\phi^k  = \left(\sqrt{-g}\right)^2\,\, (3!)^2 \det B^{ij}.
\end{align}
...
\end{equation}
The energy-momentum tensor is obtained by varying wrt the metric \notetag{And we avoid issues with symmetrizing}
