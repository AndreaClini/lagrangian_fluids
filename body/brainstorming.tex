...
\begin{align}
    ...
    -  \frac{\bigg[2\,\bar{B}\bar{Y} (\partial_{B Y}^2\bar{F})-\bar{Y}(\partial_{Y}\bar{F})-\bar{Y}^2(\partial_{Y}^2\bar{F})\bigg]^2}{2\bar{Y}^2(\partial_{Y}^2\bar{F})}}{ \tfrac12 \bar{Y}(\partial_Y\bar{F}) -\bar{B} (\partial_B\bar{F})}
    \\
    &=\dots
\end{align}
