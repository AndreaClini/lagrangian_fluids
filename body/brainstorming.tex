...
\noindent
To show positivity of $c_s^2 - c_a^2$ it might be useful to express everything in terms of thermodynamic potentials like the Helmoltz $A=A(T,n)$ or Gibbs $G=G(T,p)$ free energies.
...
\end{align}
We might be able to explicitate this condition further using Maxwell relations.\todotag{do it}
